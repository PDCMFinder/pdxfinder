...
function ebiFrameworkCreateDataProtectionBanner() {
	...
	banner.style = "position: fixed; background-color: #fff; border-top:5px solid #06369d; font-size: 14px; width: 100%; padding: .75rem; left: 0; bottom: 0; color: #000;"
...
function ebiFrameworkRunDataProtectionBanner() {
	try {
		dataProtectionSettings.message = 'This website requires cookies, and the limited processing of your personal data in order to function. By using the site you are agreeing to this as outlined in our <a target="_blank" href="http://www.ebi.ac.uk/data-protection/privacy-notice/pdx-finder">Privacy Notice</a> and <a target="_blank" href="http://www.pdxfinder.org/terms-of-use">Terms of Use</a>.';
