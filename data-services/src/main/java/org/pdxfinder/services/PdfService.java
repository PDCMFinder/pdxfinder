...
public class PdfService {
    ...
    public List<Object> generatePdf(DetailsDTO data, String modelUrl) {
        ...
        Object firstContent = logoHeaderDesign(data.getModelId(), modelUrl, data.getMappedOntology());
    ...
    public Map<String, Object> logoHeaderDesign(String modelID, String qrCodeData, String diagnosis) {
        ...
        String qrCodeImage = "";
        //pdf.base64EncodeToString(pdf.generateQRCode(modelID, qrCodeData));
