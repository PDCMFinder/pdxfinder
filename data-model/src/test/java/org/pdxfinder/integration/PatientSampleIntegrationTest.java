...
public class PatientSampleIntegrationTest extends BaseTest {
    ...
    public void persistPatientAndTumor() throws Exception {
        ...
        for (Integer i = 0; i < 20; i++) {
            ...
            Sample sample = new Sample("sample-" + i, tumorType, "TEST_DIAGNOSIS", tissue, tissue, "TEST_CLASSIFICATION", false, externalDataSource);
        ...
        for (Integer i = 0; i < 22; i++) {
            ...
            Sample sample = new Sample("sample-" + i, tumorType, "TEST_DIAGNOSIS", tissue, tissue, "TEST_CLASSIFICATION", false, externalDataSourceAlternate);
            sampleRepository.save(sample);
