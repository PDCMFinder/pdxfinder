...
public class ValidationRestrictionTests {
    ...
    @Test public void UrlSafeRegex_worksAppropriately(){
        ...
        Predicate<String> urlSafeRegex = PdxValidationConstants.getUrlSafeCharset()
    ...
    @Test public void FreeTextRegex_worksAppropriately(){
        ...
        Predicate<String> FreeTextRegex = PdxValidationConstants.getFreeTextCharset()
            .getInvalidValuePredicate();
    ...
    @Test public void numberRegex_worksAppropriately(){
        ...
        Predicate<String> numberRegex = PdxValidationConstants.getNumericalCharset()
            .getInvalidValuePredicate();
    ...
    @Test public void ListToRegex_givenList_regexHasDiscreteCategories(){
        List<String> categories = Arrays.asList("a", "test", "for", "regex", "categories", "value with space");
        String expectedfail = "test";
