...
@PropertySource("file:${user.home}/configfiles/pdxfinder/${profile:dev}/application.properties")
public class Application {
    ...
    CommandLineRunner demo(PatientRepository patientRepository, TumorTypeRepository tumorTypeRepository) {
        return args -> {
            ...
            Tumor t = new Tumor("tumor 1", metastatic, null, null, null, null);
            Tumor t2 = new Tumor("tumor 2", recurrent, null, null, null, null);
